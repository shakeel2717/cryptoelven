                            ...
                            <tbody>
                                @forelse ($users as $user)
                                    <tr>
                                        ...
                                        <td class="text-center text-capitalize">{{ $user->user->name }}</td>
                                        <td class="text-center text-capitalize">{{ $user->user->username }}</td>
                                        <td class="text-center text-capitalize">{{ $user->user->email }}</td>
